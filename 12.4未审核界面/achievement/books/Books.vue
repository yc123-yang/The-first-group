  ...
  <div>
    ...
    <el-card>
      <el-menu mode="horizontal" active-text-color="#409EFF" :default-active="activeTab" router>
        <el-menu-item index="/books/query">查询著作成果</el-menu-item>
        <el-menu-item index="/books/manage">管理著作成果</el-menu-item>
        <el-menu-item index="/books/wait">管理未审核著作成果</el-menu-item>
      </el-menu>
