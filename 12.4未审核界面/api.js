...
const menulist = [{
  ...
  children: [{
    ...
    children: [
      ...
      { id: 3113, name: '管理未审核科研项目', path: 'projects/wait' },
    ]
  }]
}, {
  id: 102,
  ...
  children: [{
    ...
    children: [
      ...
      { id: 3213, name: '管理未审核论文成果', path: 'papers/wait' }
    ]
  }, {
    id: 222,
    name: '著作成果',
    ...
    children: [
      ...
      { id: 3223, name: '管理未审核著作成果', path: 'books/wait' },
    ]
  }, {
    id: 223,
    name: '科研成果获奖',
    ...
    children: [
      ...
      { id: 3233, name: '管理未审核成果获奖', path: 'awards/manage' }
    ]
  }, {
    id: 224,
    name: '专利与产品',
    ...
    children: [
      ...
      { id: 3243, name: '管理未审核专利产品', path: 'patents/wait' }
    ]
  }]
}, {
  id: 103,
