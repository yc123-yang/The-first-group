<template>
  <div style="margin-top: 25px">
    <el-button type="primary" size="medium" @click="addProjectsDialogVisible = true">录入项目</el-button>
    <el-button type="danger" size="medium" :disabled="selection.length === 0">删除项目</el-button>
    <el-button type="warning" size="medium" @click="print">导出信息</el-button>

    <el-table :data="projectsList" style="width: 100%; margin-top: 15px" border @selection-change="selectionChange" :header-cell-style="{ background: '#f5f7fa' }">
      <!-- 序号列 -->
      ...
      <el-table-column prop="project_name" label="项目名称" width="300px" align="center" fixed>
        <template slot="header" slot-scope="scope"
          ...
          <el-input class="columnInput" size="mini" clearable v-model="queryInfo.project_name" placeholder="请输入" @change="QueryProjectList"> </el-input>
        </template>
      </el-table-column>
      <el-table-column prop="project_id" label="项目编号" width="200px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-input class="columnInput" size="mini" clearable v-model="queryInfo.project_id" placeholder="请输入" @change="QueryProjectList"> </el-input>
        </template>
      </el-table-column>
      <el-table-column prop="department_name" label="归属单位" width="200px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.department_id" size="mini" @change="QueryProjectList" collapse-tags placeholder="请选择" clearable>
      ...
      <el-table-column prop="sc_name" label="学科门类" width="150px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.sc_id" size="mini" @change="QueryProjectList" collapse-tags placeholder="请选择" clearable>
      ...
      <el-table-column prop="subject_name" label="一级学科" width="200px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.subject_id" size="mini" @change="QueryProjectList" collapse-tags placeholder="请选择" clearable>
      ...
      <el-table-column prop="nature_name" label="项目性质" width="150px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.nature_id" size="mini" @change="QueryProjectList" collapse-tags placeholder="请选择" clearable>
      ...
      <el-table-column prop="level_name" label="项目级别" width="150px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.level_id" size="mini" @change="QueryProjectList" collapse-tags placeholder="请选择" clearable>
      ...
      <el-table-column prop="status_name" label="项目状态" width="150px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.status_id" size="mini" @change="QueryProjectList" collapse-tags placeholder="请选择" clearable>
      ...
      <el-table-column prop="sd_name" label="来源单位" width="200px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.sd_id" size="mini" @change="QueryProjectList" collapse-tags placeholder="请选择" clearable>
            <el-option v-for="item in departmentList" :key="item.department_id" :label="item.department_name" :value="item.department_id"> </el-option>
          </el-select>
        </template>
      </el-table-column>
      <el-table-column prop="approval_number" label="批准文号" width="200px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-input class="columnInput" size="mini" clearable v-model="queryInfo.approval_number" placeholder="请输入" @change="QueryProjectList"> </el-input>
        </template>
      </el-table-column>
      <el-table-column prop="start_time" label="立项日期" width="230px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" v-model="start_time" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd" @change="QueryProjectList"> </el-date-picker>
        </template>
      </el-table-column>
      <el-table-column prop="plan_time" label="计划完成日期" width="230px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" v-model="plan_time" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd" @change="QueryProjectList"> </el-date-picker>
        </template>
      </el-table-column>
      <el-table-column prop="complete_time" label="结项日期" width="230px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" v-model="complete_time" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd" @change="QueryProjectList"> </el-date-picker>
        </template>
      </el-table-column>
      <el-table-column prop="outlay" label="合同经费" width="150px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-input class="columnInput" size="mini" clearable v-model="queryInfo.outlay" placeholder="请输入" @change="QueryProjectList"> </el-input>
        </template>
      </el-table-column>
      <el-table-column prop="ct_name" label="结题形式" width="150px" align="center">
        <template slot="header" slot-scope="scope"
          ...
          <el-select class="columnInput" v-model="queryInfo.ct_id" size="mini" collapse-tags placeholder="请选择" clearable @change="QueryProjectList">
    ...
    <!-- 录入项目对话框 -->
    <el-dialog title="录入项目" :visible.sync="addProjectsDialogVisible" width="60%" @close="addProjectsDialogClosed">
        ...
        <el-row :gutter="20">
          ...
          <el-col>
            ...
            <el-form-item label="项目名字:" prop="project_name">
              <el-input v-model="addForm.project_name" size="mini"></el-input>
            </el-form-item>
            <!-- 归属单位、项目来源 -->
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="归属单位:" prop="department">
                  <el-select v-model="addForm.department" placeholder="请选择" size="mini" style="width: 100%">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="项目性质:" prop="nature">
                  <el-select v-model="addForm.nature" placeholder="请选择" size="mini" style="width: 100%">
                    <el-option v-for="item in natureList" :label="item.nature_name" :value="item.nature_id" :key="item.nature_id"> </el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="项目级别:" prop="level">
                  <el-select v-model="addForm.level" placeholder="请选择" size="mini" style="width: 100%">
                    <el-option v-for="item in levelList" :label="item.level_name" :value="item.level_id" :key="item.level_id"> </el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="项目状态:" prop="status">
                  <el-select v-model="addForm.status" placeholder="请选择" size="mini" style="width: 100%">
                    <el-option v-for="item in statusList" :label="item.status_name" :value="item.status_id" :key="item.status_id"> </el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="成果形式:" prop="level">
                  <el-select v-model="addForm.level" placeholder="请选择" size="mini" style="width: 100%">
                    <el-option v-for="item in levelList" :label="item.level_name" :value="item.level_id" :key="item.level_id"> </el-option>
                  </el-select>
                </el-form-item>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="经费:" prop="outlay">
                  <el-input v-model="addForm.outlay" size="mini"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- 开始时间，计划时间 -->
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="开始时间:" prop="start_time">
                  <el-date-picker type="date" placeholder="请选择日期" v-model="addForm.start_time" style="width: 100%" size="mini"> </el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="计划时间:" prop="plan_time">
                  <el-date-picker type="date" placeholder="请选择日期" v-model="addForm.plan_time" style="width: 100%" size="mini"> </el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="完成时间:" prop="complete_time">
                  <el-date-picker type="date" placeholder="请选择日期" v-model="addForm.complete_time" style="width: 100%" size="mini"> </el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="成果形式:" prop="ct">
                  <el-select v-model="addForm.ct" placeholder="请选择" size="mini" style="width: 100%">
                    <el-option v-for="item in ctList" :label="item.ct_name" :value="item.ct_id" :key="item.ct_id"> </el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>

            <el-table label="操作" align="center" width="120" fixed="right">
              <template slot-scope="scope"
                >{{ scope.haha }}
                <el-button type="primary" icon="el-icon-edit" size="mini"></el-button>
                <el-button type="danger" icon="el-icon-delete" size="mini"></el-button>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addProjectsDialogVisible = false">取 消</el-button>
...
export default {
  data() {
    return {
      ...
      selection: [],
      // // 控制录入专利成果对话框显示与隐藏变量
      addProjectsDialogVisible: false,
    };
  },
