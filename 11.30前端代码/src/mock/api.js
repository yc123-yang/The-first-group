...
if (flag) {
  ...
  // 获取待审核成论文果列表
  Mock.mock('http://localhost:8080/check/paper/findAllPaperByCondition', 'post', {
    status: '200',
    msg: '查询论文成果信息成功',
    data: [
      { total: papersList.list.length },
  ...
  // 获取待审核著作成果列表
  Mock.mock('http://localhost:8080/check/book/findAllBookByCondition', 'post', {
    status: '200',
    msg: '查询著作成果信息成功',
    data: [
      { total: booksList.list.length },
  ...
  // 获取待审核获奖成果列表
  Mock.mock('http://localhost:8080/check/award/findAllAwardByCondition', 'post', {
    status: '200',
    msg: '查询获奖成果成功',
    data: [
      { total: awardsList.list.length },
  ...
  // 获取待审核专利列表
  Mock.mock('http://localhost:8080/check/patent/findAllPatentByCondition', 'post', {
    status: '200',
    msg: '查询专利信息成功',
    data: [
      { total: patentsList.list.length },
  ...
  // 根据待审核论文成果id获取待审核论文成果详细信息
  Mock.mock('http://localhost:8080/check/paper/findPaperById', 'post', {
    status: '200',
    msg: '获取待审核论文成果详细信息成功',
    data: {
      paper_name: '@cname',
  ...
  // 根据待审核著作成果id获取待审核著作成果详细信息
  Mock.mock('http://localhost:8080/check/book/findBookById', 'post', {
    status: '200',
    msg: '获取待审核著作成果详细信息成功',
    data: {
      'book_id|+1': 1,
  ...
  // 根据待审核获奖成果id获取待审核获奖成果详细信息
  Mock.mock('http://localhost:8080/check/award/findAwardById', 'post', {
    status: '200',
    msg: '获取待审核获奖成果详细信息成功',
    data: {
      'award_id|+1': 1,
  ...
  // 根据待审核专利成果id获取待审核专利成果详细信息
  Mock.mock('http://localhost:8080/check/patent/findPatentById', 'post', {
    status: '200',
    msg: '获取待审核专利成果详细信息成功',
    data: {
      'patent_id|+1': 1,
  ...
  // 批准论文成果申请
  Mock.mock('http://localhost:8080/check/paper/approve', 'post', {
    status: '200',
    msg: '成功通过了论文成果审核',
    data: null
  })
  // 批准著作成果申请
  Mock.mock('http://localhost:8080/check/book/approve', 'post', {
    status: '200',
    msg: '成功通过了著作成果审核',
    data: null
  })
  // 批准获奖成果申请
  Mock.mock('http://localhost:8080/check/award/approve', 'post', {
    status: '200',
    msg: '成功通过了获奖成果审核',
    data: null
  })
  // 批准专利成果申请
  Mock.mock('http://localhost:8080/check/patent/approve', 'post', {
    status: '200',
    msg: '成功通过了专利成果审核',
    data: null
  })
  ...
  // 驳回论文成果申请
  Mock.mock('http://localhost:8080/check/paper/deny', 'post', {
    status: '200',
    msg: '驳回论文成果申请成功',
    data: null
  })
  // 驳回著作成果申请
  Mock.mock('http://localhost:8080/check/book/deny', 'post', {
    status: '200',
    msg: '驳回著作成果申请成功',
    data: null
  })
  // 驳回获奖成果申请
  Mock.mock('http://localhost:8080/check/award/deny', 'post', {
    status: '200',
    msg: '驳回获奖成果申请成功',
    data: null
  })
  // 驳回专利成果申请
  Mock.mock('http://localhost:8080/check/patent/deny', 'post', {
    status: '200',
    msg: '驳回专利成果申请成功',
    data: null
  })
