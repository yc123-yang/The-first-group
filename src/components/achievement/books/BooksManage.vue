    ...
    <el-table :data="booksList" style="width: 100%; margin-top: 15px" border @selection-change="selectionChange"
      ...
      <el-table-column prop="publish_time" label="发表日期" width="230px" align="center">
        <template slot="header" slot-scope="scope">
          ...
          <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" @change="QueryBookList" value-format="yyyy-MM-dd 00:00:00"
            v-model="publish_time" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"> </el-date-picker>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="language_name" label="翻译语种" width="200px" align="center">
        <template slot="header" slot-scope="scope">
          ...
          <el-select @change="QueryBookList" class="columnInput" v-model="queryInfo.language_id" size="mini" clearable placeholder="请选择">
      ...
      <el-table-column prop="sc_name" label="学科门类" width="200px" align="center">
        <template slot="header" slot-scope="scope">
          ...
          <el-select @change="QueryBookList" class="columnInput" v-model="queryInfo.sc_id" size="mini" clearable placeholder="请选择">
      ...
      <el-table-column prop="subject_name" label="一级学科" width="200px" align="center">
        <template slot="header" slot-scope="scope">
          ...
          <el-select @change="QueryBookList" class="columnInput" v-model="queryInfo.subject_id" size="mini" clearable placeholder="请选择">
      ...
      <el-table-column prop="aod_name" label="归属单位" width="200px" align="center">
        <template slot="header" slot-scope="scope">
          ...
          <el-select @change="QueryBookList" class="columnInput" v-model="queryInfo.aod_id" size="mini" clearable placeholder="请选择">
      ...
      <el-table-column prop="sd_name" label="项目来源" width="250px" align="center">
        <template slot="header" slot-scope="scope">
          ...
          <el-select @change="QueryBookList" class="columnInput" v-model="queryInfo.sd_id" size="mini"  clearable placeholder="请选择">
            <el-option v-for="item in departmentList" :key="item.department_id" :label="item.department_name" :value="item.department_id"> </el-option>
          </el-select>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="rt_name" label="研究类别" width="250px" align="center">
        <template slot="header" slot-scope="scope">
          ...
          <el-select @change="QueryBookList" class="columnInput" v-model="queryInfo.rt_id" size="mini" clearable placeholder="请选择">
