      ...
      <el-table :data="awardsList" style="width: 100%" border :header-cell-style="{ background: '#f5f7fa' }">
        ...
        <el-table-column prop="award_time" label="获奖日期" width="230px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" v-model="award_time"
            type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd 00:00:00"
            @change="getAwardList"> </el-date-picker>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="ar_name" label="获奖级别" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getAwardList" class="columnInput" v-model="queryInfo.ar_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="al_name" label="获奖等级" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getAwardList" class="columnInput" v-model="queryInfo.al_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="sc_name" label="学科门类" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getAwardList" class="columnInput" v-model="queryInfo.sc_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="subject_name" label="一级学科" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getAwardList" class="columnInput" v-model="queryInfo.subject_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="aod_name" label="归属单位" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getAwardList" class="columnInput" v-model="queryInfo.aod_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="sd_name" label="项目来源" width="250px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getAwardList" class="columnInput" v-model="queryInfo.sd_id" size="mini" clearable placeholder="请选择">
              <el-option v-for="item in departmentList" :key="item.department_id" :label="item.department_name" :value="item.department_id"> </el-option>
            </el-select>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="at_name" label="成果形式" width="250px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getAwardList" class="columnInput" v-model="queryInfo.at_id" size="mini" clearable placeholder="请选择">
