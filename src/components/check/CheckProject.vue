  ...
  <div>
      ...
      <el-table :data="projectList" style="width: 100%;" border :header-cell-style="{background: '#f5f7fa'}">
        ...
        <el-table-column prop="department_name" label="归属单位" width="200px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-select class="columnInput" v-model="queryInfo.department_id"  size="mini" @change="getProjectList"
        ...
        <el-table-column prop="sc_name" label="学科门类" width="150px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-select class="columnInput" v-model="queryInfo.sc_id"  size="mini" @change="getProjectList"
              collapse-tags placeholder="请选择" clearable>
        ...
        <el-table-column prop="subject_name" label="一级学科" width="200px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-select class="columnInput" v-model="queryInfo.subject_id"  size="mini" @change="getProjectList"
              collapse-tags placeholder="请选择" clearable>
        ...
        <el-table-column prop="nature_name" label="项目性质" width="150px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-select class="columnInput" v-model="queryInfo.nature_id"  size="mini" @change="getProjectList"
              collapse-tags placeholder="请选择" clearable>
        ...
        <el-table-column prop="level_name" label="项目级别" width="150px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-select class="columnInput" v-model="queryInfo.level_id"  size="mini" @change="getProjectList"
              collapse-tags placeholder="请选择" clearable>
        ...
        <el-table-column prop="status_name" label="项目状态" width="150px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-select class="columnInput" v-model="queryInfo.status_id"  size="mini" @change="getProjectList"
              collapse-tags placeholder="请选择" clearable>
        ...
        <el-table-column prop="sd_name" label="来源单位" width="200px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-select class="columnInput" v-model="queryInfo.sd_id"  size="mini" @change="getProjectList"
              collapse-tags placeholder="请选择" clearable>
              <el-option v-for="item in departmentList" :key="item.department_id" :label="item.department_name"
                :value="item.department_id">
              </el-option>
        ...
        <el-table-column prop="start_time" label="立项日期" width="230px" align="center">
          <template slot="header" slot-scope="scope">
            ...
            <el-date-picker class="columnInput" style="width: 200px; padding-right: 0;" size="mini"
              ...
              end-placeholder="结束日期" value-format="yyyy-MM-dd 00:00:00" @change="getProjectList">
            </el-date-picker>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="ct_name" label="结题形式" width="150px" align="center">
          <template slot="header" slot-scope="scope"> 
            ...
            <el-select class="columnInput" v-model="queryInfo.ct_id"  size="mini"
              collapse-tags placeholder="请选择" clearable @change="getProjectList">
    ...
    <el-dialog title="审核项目申请" :visible.sync="checkProjectDialogVisible" width="50%">
      <el-form class="dialog" label-width="110px">
        ...
        <el-row>
          <el-col :span="12"><el-form-item label="学科门类：">{{projectInfo.sc_name}}</el-form-item></el-col>
          <el-col :span="12"><el-form-item label="一级学科：">{{projectInfo.subject_name}}</el-form-item></el-col>
        </el-row>
        <el-row>
          <el-col><el-form-item label="项目性质：">{{projectInfo.nature_name}}</el-form-item></el-col>
        </el-row>
        <el-row>
          <el-col><el-form-item label="项目级别：">{{projectInfo.level_name}}</el-form-item></el-col>
        </el-row>
        <el-row>
          <el-col :span="12"><el-form-item label="项目状态：">{{projectInfo.status_name}}</el-form-item></el-col>
          <el-col :span="12"><el-form-item label="来源单位：">{{projectInfo.sd_name}}</el-form-item></el-col>
        </el-row>
        <el-row>
          <el-col :span="12"><el-form-item label="成果形式：">{{projectInfo.ct_name}}</el-form-item></el-col>
