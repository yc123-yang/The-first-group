      ...
      <el-table :data="patentsList" style="width: 100%" border :header-cell-style="{ background: '#f5f7fa' }">
        ...
        <el-table-column prop="pt_name" label="专利类型" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getPatentList" class="columnInput" v-model="queryInfo.pt_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="pr_name" label="专利范围" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getPatentList" class="columnInput" v-model="queryInfo.pr_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="ps_name" label="专利状态" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getPatentList" class="columnInput" v-model="queryInfo.ps_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="aod_name" label="归属单位" width="200px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-select @change="getPatentList" class="columnInput" v-model="queryInfo.aod_id" size="mini" clearable placeholder="请选择">
        ...
        <el-table-column prop="application_time" label="申请日期" width="230px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" value-format="yyyy-MM-dd 00:00:00"
              v-model="application_time" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="getPatentList"> </el-date-picker>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="public_time" label="公开日期" width="230px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" value-format="yyyy-MM-dd 00:00:00"
              v-model="public_time" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="getPatentList"> </el-date-picker>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="authorization_time" label="授权日期" width="230px" align="center">
          <template slot="header" slot-scope="scope"
            ...
            <el-date-picker class="columnInput" style="width: 200px; padding-right: 0" size="mini" value-format="yyyy-MM-dd 00:00:00"
              v-model="authorization_time" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="getPatentList"> </el-date-picker>
          </template>
        </el-table-column>
