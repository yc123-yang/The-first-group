        ...
        <el-card>
            ...
            <el-row>
                <el-table :data="paperList" style="width: 100%" max-height="250" border
                    @selection-change="selectionChange" :header-cell-style="{ background: '#f5f7fa' }">
                    <!-- 序号列 -->
                    ...
                    <el-table-column prop="title" label="著作题目" width="300px" align="center" fixed>
                    ...
                    <el-table-column prop="publishUnit" label="出版单位" width="200px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">出版单位</div>
                            <el-input class="columnInput" size="mini" clearable v-model="queryInfo.publishUnit"
                                placeholder="请输入">
                            </el-input>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="publishLevel" label="出版社级别" width="200px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">出版社级别</div>
                            <el-select class="columnInput" v-model="queryInfo.publishLevel" size="mini"
                                placeholder="请选择">
                                <el-option v-for="item in publishLevelList" :key="item" :label="item" :value="item">
                                </el-option>
                            </el-select>
                        </template>
                    </el-table-column>

                    <el-table-column prop="booktype" label="著作类别" width="200px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">著作类别</div>
                            <el-select class="columnInput" v-model="queryInfo.booktype" multiple size="mini"
                                collapse-tags placeholder="请选择">
                                <el-option v-for="item in booktypeList" :key="item" :label="item" :value="item">
                                </el-option>
                            </el-select>
                        </template>
                    </el-table-column>

                    <el-table-column prop="pubplace" label="出版地" width="200px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">出版地</div>
                            <el-select class="columnInput" v-model="queryInfo.pubplace" multiple size="mini"
                                collapse-tags placeholder="请选择">
                                <el-option v-for="item in pubplaceList" :key="item" :label="item" :value="item">
                                </el-option>
                            </el-select>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="iSBN" label="ISBN号" width="150px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            ...
                            <el-input class="columnInput" size="mini" clearable v-model="queryInfo.iSBN"
                                placeholder="请输入">
                            </el-input>
                        </template>
                    </el-table-column>

                    <el-table-column prop="allLeters" label="总字数" width="150px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">总字数</div>
                            <el-input class="columnInput" size="mini" clearable v-model="queryInfo.allLeters"
                                placeholder="请输入">
                            </el-input>
                        </template>
                    </el-table-column>

                    <el-table-column prop="translaTion" label="是否翻译" width="200px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">是否翻译</div>
                            <el-select class="columnInput" v-model="queryInfo.translaTion" multiple size="mini"
                                collapse-tags placeholder="请选择">
                                <el-option v-for="item in translaTionList" :key="item" :label="item" :value="item">
                                </el-option>
                            </el-select>
                        </template>
                    </el-table-column>

                    <el-table-column prop="language" label="翻译语种" width="200px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">翻译语种</div>
                            <el-select class="columnInput" v-model="queryInfo.language" multiple size="mini"
                                collapse-tags placeholder="请选择">
                    ...
                    <el-table-column prop="source" label="项目来源" width="250px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            ...
                            <el-select class="columnInput" v-model="queryInfo.source" multiple size="mini" collapse-tags
                                placeholder="请选择">
                    ...
                    <el-table-column prop="proType" label="研究类别" width="250px" align="center">
                        <template slot="header" slot-scope="scope">{{ scope.haha }}
                            <div style="line-height: 14px">研究类别</div>
                            <el-select class="columnInput" v-model="queryInfo.proType" multiple size="mini"
                                collapse-tags placeholder="请选择">
                                <el-option v-for="item in proTypeList" :key="item" :label="item" :value="item">
                                </el-option>
                            </el-select>
                        </template>
                    </el-table-column>
            ...
            <!-- 录入著作成果对话框 -->
            <el-dialog title="录入著作成果" :visible.sync="addBooksDialogVisible" width="70%" @close="addBooksDialogClosed">
                            ...
                            <el-row :gutter="20">
                                ...
                                <el-col :span="12">
                                    <el-form-item label="出版社级别:" prop="publishLevel">
                                        <el-select v-model="addForm.publishLevel" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in publishLevelList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                            ...
                            <el-row :gutter="20">
                                <el-col :span="12">
                                    <el-form-item label="著作类别:" prop="booktype">
                                        <el-select v-model="addForm.booktype" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in booktypeList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="出版地:" prop="pubplace">
                                        <el-select v-model="addForm.pubplace" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in pubplaceList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                            ...
                            <el-row :gutter="20">
                                ...
                                <el-col :span="7">
                                    <el-form-item label="总字数:" prop="allLeters">
                                        <el-input v-model="addForm.allLeters" size="mini"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row :gutter="20">
                                <el-col :span="12">
                                    <el-form-item label="是否翻译:" prop="translaTion">
                                        <el-select v-model="addForm.translaTion" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in translaTionList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="翻译语种:" prop="language">
                                        <el-select v-model="addForm.language" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in languageList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="学科门类:" prop="subjectCate">
                                        <el-select v-model="addForm.subjectCate" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in subjectCateList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                            ...
                            <el-row :gutter="20">
                                <el-col :span="12">
                                    <el-form-item label="一级学科:" prop="subject">
                                        <el-select v-model="addForm.subject" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in subjectList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="归属单位:" prop="attribution">
                                        <el-select v-model="addForm.attribution" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in attributionList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                            ...
                            <el-row :gutter="20">
                                <el-col :span="12">
                                    <el-form-item label="项目来源:" prop="source">
                                        <el-select v-model="addForm.source" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in sourceList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="研究类别:" prop="proType">
                                        <el-select v-model="addForm.proType" placeholder="请选择" size="mini"
                                            style="width: 100%">
                                            <el-option v-for="item in proTypeList" :label="item" :value="item"
                                                :key="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                            ...
                            <el-table :data="addForm.authorList" style="width: 100%" ref="authorTableRef"
                                ...
                                <el-table-column prop="authorName" label="作者姓名" width="120px" align="center">
                                    <template slot="header" slot-scope="scope">{{ scope.haha }}
                                        ...
                                        <el-input class="columnInput" size="mini" clearable
                                            v-model="authorQueryInfo.authorName" placeholder="请输入">
                                        </el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="authorType" label="成员类型" width="180px" align="center">
                                    <template slot="header" slot-scope="scope">{{ scope.haha }}
                                        ...
                                        <el-select class="columnInput" v-model="authorQueryInfo.authorType" multiple
                                            size="mini" collapse-tags placeholder="请选择">
                                            <el-option v-for="item in authorTypeList" :key="item" :label="item"
                                                :value="item">
                                            </el-option>
                                        </el-select>
                                    </template>
                                ...
                                <el-table-column prop="employer" label="归属单位" width="200px" align="center">
                                    <template slot="header" slot-scope="scope">{{ scope.haha }}
                                        ...
                                        <el-select class="columnInput" v-model="authorQueryInfo.employer" multiple
                                            size="mini" collapse-tags placeholder="请选择">
                                            <el-option v-for="item in attributionList" :key="item" :label="item"
                                                :value="item">
                                            </el-option>
                                        </el-select>
                                    </template>
